...
app.get('/host', (req, res) => {
  ...
  console.log('host[platform][appVersion]', host[platform][appVersion]);
...
app.get('/booking', (req, res) => {
  const platform = req.query.platform;
  const appVersion = req.query.appVersion;
  console.log('booking[platform][appVersion]', booking[platform][appVersion]);
...
app.get('/shopping', (req, res) => {
  const platform = req.query.platform;
  const appVersion = req.query.appVersion;
  console.log('shopping[platform][appVersion]', shopping[platform][appVersion]);
...
app.get('/dashboard', (req, res) => {
  ...
  console.log('dashboard[platform][appVersion]', dashboard[platform][appVersion]);
